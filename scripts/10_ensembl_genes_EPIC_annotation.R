...
ensembl_transcripts<-read.csv(here("data","ensembl_biomart_GRCh37.p13_human_genes.csv")) # 215,170 transcripts
...
save(ensembl_transcripts, file=paste(here("data"),"/ensembl_transcripts.RData",sep=""))
